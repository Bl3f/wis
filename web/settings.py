...
STATICFILES_DIRS = (
    ...
    os.path.join(os.path.dirname(__file__), "apps/gallery/static").replace("\\", "/"),
)
...
SECRET_KEY = 'ete*@*_bu@(rt=!dlvwp97p)pv5u64&amp;7f%j5j0lf%*e$e5lw%l'
...
MIDDLEWARE_CLASSES = (
    ...
    'web.middleware.HistoryMiddleware',
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(os.path.dirname(__file__), "apps/gallery/templates").replace("\\", "/")
)
